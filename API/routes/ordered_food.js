...
router.post('/', async (req, res) => {
    const { id, id_client, id_food } = req.body;
    try {
        const result = await client.query('INSERT INTO ordered_food(id, id_client, id_ordered_food) VALUES($1, $2, $3) RETURNING *', [id, id_client, id_food]);
